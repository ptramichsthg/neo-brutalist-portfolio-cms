...
const Navbar: React.FC<NavbarProps> = ({ onHomeClick, currentView = 'home' }) => {
            ...
            <button
              ...
              className={`
                ...
                ${isMenuOpen
                  ...
                  : 'bg-white shadow-[3px_3px_0_0_rgba(0,0,0,1)] active:shadow-none active:translate-x-0.5 active:translate-y-0.5'
                }
              `}
            ...
            >
              ...
              <div className="space-y-1 sm:space-y-2 pt-12 xs:pt-16">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 h-px opacity-20 bg-black"></div>
                </div>
                <h2 className="text-4xl xs:text-5xl sm:text-6xl font-black uppercase italic tracking-tighter leading-none text-black">Menu</h2>
              </div>
                ...
                {navLinks.map((link, idx) => (
                  <button
                    ...
                    className={`
                      ...
                      ${activeSection === link.id ? 'bg-cyan-400 -translate-x-1 shadow-[4px_4px_0_0_rgba(0,0,0,1)]' : 'bg-white shadow-[2px_2px_0_0_rgba(0,0,0,1)]'}
                    `}
                    style={{ transitionDelay: `${idx * 50}ms` }}
                  >
                    <div className="flex flex-col items-start">
                      <span className="text-[8px] font-black uppercase opacity-30 leading-none mb-1 text-black">Channel_0{idx + 1}</span>
                      <span className="text-xl xs:text-2xl sm:text-3xl font-black uppercase italic tracking-tighter leading-none text-black">{link.name}</span>
                    </div>
              ...
              <div className="mt-auto space-y-4 xs:space-y-6 pt-4 border-t-[3px] border-black border-dashed">
                ...
                <div className="flex gap-2">
                  <a href="https://github.com/Ptramichael" target="_blank" rel="noopener noreferrer" className="flex-1 text-center py-2 sm:py-3 border-[3px] border-black font-black uppercase text-xs sm:text-sm transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0_0_rgba(0,0,0,1)] hover:bg-black hover:text-white bg-white text-black">
                    GitHub
                  </a>
                  <a href="https://www.linkedin.com/in/putra-michael-sitohang-635b7122b/" target="_blank" rel="noopener noreferrer" className="flex-1 text-center py-2 sm:py-3 border-[3px] border-black font-black uppercase text-xs sm:text-sm transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[3px_3px_0_0_rgba(0,0,0,1)] hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] bg-white text-black">
                    LinkedIn
                  </a>
                </div>
                ...
                <div className="flex items-end justify-between">
                  <div className="flex flex-col gap-1">
                    <span className="text-[8px] xs:text-[10px] font-black uppercase opacity-40 leading-none text-black">Global Operations</span>
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 bg-lime-500 rounded-full animate-pulse border border-black/20"></span>
                      <span className="text-xs xs:text-sm sm:text-lg font-black uppercase italic leading-none text-black">West Bandung Regency // Active</span>
                    </div>
                  </div>
